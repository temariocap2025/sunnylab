    ...
    <div class="res-chart">
        ...
        <script>
            document.getElementById("dataType").addEventListener("change", function() {
                window.location.href = "?seccion=test" + "&dataType=" + this.value + "&timeRange=" + document.getElementById("timeRange").value;
            });
            document.getElementById("timeRange").addEventListener("change", function() {
                window.location.href = "?seccion=test" + "&dataType=" + document.getElementById("dataType").value + "&timeRange=" + this.value;
            });
